...
export function CadastreSection({ user } : CadastreSectionProps) {
  ...
  return (
    <section className="w-full bg-[#142057] text-sun-50">
      <div className="flex items-center justify-around">
        ...
        <div id="texto" className="text-center">
          ...
          <div className="text-[2.34031rem] max-w-[35rem]">
            <p>
              <Link href="/cadastro"><span className="underline">Cadastre-se</span></Link> e adquira já a mais nova solução de heatmapping no mercado!
            </p>
          </div>
        </div>
      </div>
